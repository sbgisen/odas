    ...
    */
    ...
    interface_obj * interface_construct_unix_domain_socket(const char * uds_path) {
        ...
        // +----------------------------------------------------------+
            ...
            obj->type = interface_unix_domain_socket;
        ...
        obj->uds_path = (char *) malloc(sizeof(char) * (strlen(uds_path)+1));
        strcpy(obj->uds_path, uds_path);
   ...
   interface_obj * interface_construct_soundcard_by_name(char * deviceName) {
    ...
    interface_obj * interface_clone(const interface_obj * obj) {
        ...
        // +----------------------------------------------------------+
            ...
            if (obj->type == interface_unix_domain_socket){
                clone->uds_path = obj->uds_path;
            }
    ...
    void interface_destroy(interface_obj * obj) {
        ...
        */
        ...
        if (obj->uds_path != NULL){
            free((void *) obj->uds_path);
            obj->uds_path = NULL;
        }
        ...
        if (obj != NULL) {
            ...
            switch(obj->type) {
                ...
                case interface_unix_domain_socket:
                    printf("type = unix domain socket, socket filename = %s\n",obj->uds_path);
                break;
